...
- R is an /interpreted language/ - instructions are entered via CLI[fn:3]
...
- You can (often) get help on datasets with ~?~ or ~help([name])~[fn:4]
...
- RStudio is a popular (free) IDE for R - use it at your own [[https://moodle.hwr-berlin.de/mod/book/view.php?id=939064&chapterid=8130][peril]]!
...
[fn:4]Strictly speaking, the availability of help depends on the
...
[fn:3]In fact, you can also save R instructions as a script and then
