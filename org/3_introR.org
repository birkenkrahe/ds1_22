...
* SOMEDAY Obtaining and installing r from cran
...
#+end_notes
* DONE Practice: download practice files
...
* DONE Opening r for the first time
...
* DONE Practice: find R / run R scripts
