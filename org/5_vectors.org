...
* IN PROGRESS Practice: creating vectors
DEADLINE: <2022-09-26 Mon 08:00>
#+attr_html: :width 400px
[[../img/5_gnome.jpg]]

- Practice what you've learnt by solving problems independently
- Save the [[https://raw.githubusercontent.com/birkenkrahe/ds1/piHome/org/5_vectors_practice.org][raw practice file from GitHub]] as an Org-mode file
- Complete the file in Emacs by using R code blocks
- [[https://lyon.instructure.com/courses/568/assignments/2952][Submit the result on Canvas]] no later than Monday September 26 8 am
...
* TODO Length of ~names~ vs. vector
