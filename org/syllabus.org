...
- Class session schedule  
  ...
  |----+------------+------------+--------------------+-------------------------------|
  |  1 | Wed-17-Aug | Entry test | 1 Getting started  | 1 DS intro [DC]               |
  |  2 | Fri-19-Aug |            |                    | 2 Emacs tutorial 
  |----+------------+------------+--------------------+-------------------------------|
  |  3 | Mon-22-Aug | Test 1     | 2 R for basic math | 3 Intro to R [DC]
  |  4 | Wed-24-Aug |            |                    |                               |
  |  5 | Fri-26-Aug |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  |  6 | Mon-29-Aug | Test 2     | 2.3 Vectors        | 4 Vectors [DC] 
