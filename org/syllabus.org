...
- Class session schedule  
  #+name: tab:schedule
  | NO | DATE       | TESTS      | TEXTBOOK           | ASSIGNMENT                    |
  |----+------------+------------+--------------------+-------------------------------|
  |  1 | Wed-17-Aug | Entry test | 1 Getting started  | 1 DS intro [DC] (8-22)        |
  |  2 | Fri-19-Aug |            |                    | 2 Emacs tutorial (8-26)       |
  |----+------------+------------+--------------------+-------------------------------|
  |  3 | Mon-22-Aug | Test 1     | 2 R for basic math | 3 Intro to R [DC] (08-29)     |
  |  4 | Wed-24-Aug |            |                    |                               |
  |  5 | Fri-26-Aug |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  |  6 | Mon-29-Aug | Test 2     | 2.3 Vectors        | 4 Vectors [DC] (09-07)        |
  |  7 | Wed-31-Aug |            |                    | 1st Sprint review             |
  |  8 | Fri-02-Sep |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  |  9 | Wed-07-Sep | Test 3     | 3 Matrices/Arrays  | 5 Matrices [DC]               |
  | 10 | Fri-09-Sep |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 11 | Mon-12-Sep | Test 4     | 4.1 Logical values | 6 Logical subsetting          |
  | 12 | Wed-14-Sep |            |                    |                               |
  | 13 | Fri-16-Sep |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 14 | Mon-19-Sep | Test 5     | 4.2 Characters     | 7 String manipulation         |
  | 15 | Wed-21-Sep |            |                    |                               |
  | 16 | Fri-23-Sep |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 17 | Mon-26-Sep | Test 6     | 4.3 Factors        | 8 Factors [DC]                |
  | 18 | Wed-28-Sep |            |                    |                               |
  | 19 | Fri-30-Sep |            |                    | 2nd Sprint Review             |
  |----+------------+------------+--------------------+-------------------------------|
  | 20 | Wed-05-Oct | Test 7     | 5.1 Lists          | 9 Lists [DC]                  |
  | 21 | Fri-07-Oct |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 22 | Mon-10-Oct | Test 8     | 5.2 Data Frames    | 10 Data frames [DC]           |
  | 23 | Wed-12-Oct |            |                    |                               |
  | 24 | Fri-14-Oct |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 25 | Mon-24-Oct | Test 9     | 6 Special values,  | 11 Coercing data structures   |
  | 26 | Wed-26-Oct |            | Classes, and       |                               |
  | 27 | Fri-28-Oct |            | Coercion           |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 28 | Mon-31-Oct | Test 10    | 7 Basic plotting   | 12 Quick intro [DC][fn:1]     |
  | 29 | Wed-02-Nov |            |                    | 3rd Sprint Review             |
  | 30 | Fri-04-Nov |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 31 | Mon-07-Nov | Test 11    | 7.4 ggplot2        | 13 Intro to ggplot [DC][fn:2] |
  | 32 | Wed-09-Nov |            |                    |                               |
  | 33 | Fri-11-Nov |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 34 | Mon-14-Nov | Test 12    | 8.2 Reading data   | 14 Reading data               |
  | 35 | Wed-16-Nov |            |                    |                               |
  | 36 | Fri-18-Nov |            |                    |                               |
  |----+------------+------------+--------------------+-------------------------------|
  | 37 | Mon-21-Nov | Test 13    | 8.3 Writing data   | 15 Writing data               |
  |----+------------+------------+--------------------+-------------------------------|
