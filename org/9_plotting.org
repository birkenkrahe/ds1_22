...
- [X] When do you think of using *barplots*?
  #+begin_quote
  Barplots are sensible for counting *observations of categories*
  #+end_quote
- [X] When do you think of using a *histogram*?
  #+begin_quote
...
- [X] What does the /height/ of a bar represent exactly?
  #+begin_quote
...
- [X] How can you find out what the /binwidth/ of this histogram is?
  #+begin_src R
    str(hist(Nile))
  #+end_src
...
- [X] Look at the ~help~ for ~hist~, then change the binwidth to ~30~.
