...
* Week 11-15: Dataframes / Import data / Basic plotting/ggplot2/projects
#+attr_html: :width 300px
[[../img/template.jpg]]

- [X] "I can teach it to you but I cannot learn it for you." (Rant)
- [X] Review of the DataCamp review on data frames
- [X] Finish dataframe review with a review of the review
- [ ] Data frame lab session
- [ ] Take a look at lists
- [ ] Look at basic plotting using ~plot~
- [ ] Look at how to import and store data in data frames
- [ ] 3rd sprint review: write an abstract [[https://github.com/birkenkrahe/org/blob/master/img/template.jpg][à la Nature magazine]] 

* DONE I can teach it to you but I can't learn it for you
#+attr_html: :width 600px
...
* DONE Review of the review: data frames [DataCamp]
#+attr_html: :width 400px
[[../img/df1.png]]
...
* TODO 3rd sprint review - write an abstract
...
* TODO Lab session: Create/subset data frames
#+attr_html: :width 600px
[[../img/penguins.jpg]]
...
* NEXT DataCamp assignment: lists (Oct 28)
#+attr_html: :width 500px
[[../img/certificate.png]]
...
* NEXT DataCamp assignment: importing data (Nov 2) 
* References
#+attr_html: :width 500px
[[../img/books.jpg]]
