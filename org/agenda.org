...
- [ ] 3rd sprint review: write an abstract [[https://github.com/birkenkrahe/org/blob/master/img/template.jpg][à la Nature magazine]] (below
  is an example from my current research project)
- [ ] More about data frames, and a lab session
