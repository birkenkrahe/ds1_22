...
* Week 7: Logical subsetting and extraction
#+attr_html: :width 500px
#+caption: Francisco Goya, 'The Colossus (ca. 1818–25). Museo Nacional del Prado, Madrid.
[[../img/colossus.jpeg]]

- [ ] Upload in-class practice file for [[https://github.com/birkenkrahe/ds1/blob/piHome/org/5_vectors.org]["Vectors in R"]] (or send it)
- [ ] Review test 5 - vectors and matrices in R
- [ ] 2nd sprint review due by Friday afternoon
- [ ] Lecture/lab subsetting vectors
- [ ] Next DataCamp lesson "Factors" (complete by Oct 7)

* DONE Review test 5 - vectors and matrices in R
...
* DONE Review test 6 - creating, sorting, measuring
...
* DONE Review naming vectors and indexing
...
* TODO [[https://lyon.instructure.com/courses/568/assignments/2903][Upload Vectors in R in-class practice file]]
  #+attr_html: :width 600px
  [[../img/vectorsinR.png]]
* TODO Mini-Lab: indexing vectors ([[https://github.com/birkenkrahe/ds1/blob/piHome/org/5_vectors.org#indexing-vectors][GitHub]])
  #+attr_html: :width 300px
  [[../img/indexing.jpg]]
...
* Week 8: Character and string manipulation
** TODO Review DataCamp Factors
  #+attr_html: :width 600px
  [[../img/factory.jpg]]
** TODO Lecture/practice: subsetting and extracting
  #+attr_html: :width 600px
  [[../img/extraction.png]]
** TODO Lab session: ~Nile~ extraction!
  #+attr_html: :width 500px
  [[../img/extraction.png]]
  ...
  - Download ~6_subsetting_practice.org~ [[https://github.com/birkenkrahe/ds1/blob/piHome/org/6_subsetting_practice.org][from GitHub]]:
    tinyurl.com/4azpfkpz

  - When you're done, [[https://lyon.instructure.com/courses/568/assignments/3078][upload to Canvas]]
  
* Week 9: Factors and levels
* Week 10: Data frames and lists
* Week 11-15: Plotting / Reading / Writing data / Projects
* References
#+attr_html: :width 500px
[[../img/books.jpg]]
