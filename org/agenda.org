...
- [ ] Upload in-class practice file for "Indexing vectors" (or send it)
...
- Questions (Jackson):
  ...
  2) Are we far enough in our project yet? How about in comparison
     with other projects?
