...
- *Upload* [[https://github.com/birkenkrahe/org/blob/master/FAQ.org#what-do-we-have-to-deliver-for-the-final-essay-or-presentation][some material]] to the GitHub repo ~presentations~ (see email)
- *Timing*: enter your names [[https://lyon.instructure.com/courses/568/pages/register-your-final-presentation-here][in Canvas]] (see email)

** TODO Test driving the final exam
#+attr_html: :width 600px
[[../img/fastfurious.png]]
...
6) How many different data types can you have in one vector? And what
