...
* Week 8: Subsetting and extracting, factors
#+attr_html: :width 500px
[[../img/week8.jpg]]

- [X] Review 2nd sprint review
- [X] Subsetting vectors and extracting elements
- [X] Invitation to the Lyon career fair (w/incentive)
- [ ] Review DataCamp lesson on Factors
- [ ] Lab session: subsetting with ~Nile~
- [ ] [[https://app.datacamp.com/groups/lyon-college-data-science-fall-2022/assignments][DataCamp assignments 8-10: data frames, lists, data import]]
...
* READ [[https://lyon.instructure.com/courses/568/discussion_topics/940][No class on Founder's Day Fri Oct 21]]
* Review: logical selection
...
* TODO Lab practice: ~Nile~ extraction!
#+attr_html: :width 500px
[[../img/nile.png]]

* Week 9: Data frames and lists
* Week 10: Importing external data with utils
* Week 11-15: Basic plotting/ggplot2/projects
* References
#+attr_html: :width 500px
[[../img/books.jpg]]
