...
#+STARTUP:overview hideblocks inden
...
* INTRODUCTION TO DataCamp (assignments)
#+attr_html: :width 500px
...
- There are 15 programming assignments altogether = 10 points
  each[fn:2], or 30% of your final grade.
